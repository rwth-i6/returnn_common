...
def get_sample_batch(batch_size: int = 2, sample_rate: int = 16_000) -> Tuple[nn.Tensor, nn.Dim]:
    """
    load
    """
...
def get_sample_batch_np(batch_size: int = 2, sample_rate: int = 16_000) -> Tuple[numpy.ndarray, List[int]]:
    """
    load
    """
