...
class _Bpe(VocabConfig):
    ...
    def get_opts(self) -> Dict[str, Any]:
        ...
        Get opts
        """
        return {"bpe_file": self.codes, "vocab_file": self.vocab, "unknown_label": None}  # should not be needed


_vocab_dir = Path(__file__).absolute().parent / "vocabs"


bpe1k = _Bpe(dim=1056, codes=_vocab_dir / "trans.bpe1k.codes", vocab=_vocab_dir / "trans.bpe1k.vocab")


bpe10k = _Bpe(dim=10025, codes=_vocab_dir / "trans.bpe10k.codes", vocab=_vocab_dir / "trans.bpe10k.vocab")
