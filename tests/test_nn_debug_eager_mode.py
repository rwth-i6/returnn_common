...
def test_conformer():
  ...
  conformer = nn.ConformerEncoder(
    data.feature_dim, nn.FeatureDim("conformer", 10), num_layers=2, num_heads=2,
    subsample_conv_out_dims=[32, 64], subsample_conv_filter_sizes=[(3, 3), (3, 3)],
    subsample_conv_pool_sizes=[(2, 1), (2, 1)])
