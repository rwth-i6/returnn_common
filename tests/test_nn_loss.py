...
def test_transducer_time_sync_full_sum_neg_log_prob():
    ...
    def _log_fwdbwd(source, **_kwargs):
        ...
        tf_util.opt_register_grad_func(op_type=grad_name, grad_func=_custom_grad, assert_is_same=False)
    ...
    config.update(
        dict(
            ...
            train={
                ...
                "input_base": in_dim.dimension,
                "output_base": classes_dim.dimension,
                "num_seqs": 2,
            },
        )
    )
